...
if __name__ == "__main__":
    ...
    datas = [
        {"description": "Sberbank", "city": "Moscow", "rating": 4.8},
        {"description": "VTB Bank", "city": "Saint Petersburg", "rating": 4.5},
        {"description": "Alfa-Bank", "city": "Moscow", "rating": 4.7},
        {"description": "Tinkoff", "city": "Online", "rating": 4.9}
    ]
    filter_lists = process_bank_search(datas, "bank")
    print(filter_lists)