...
def standard_16_digit_cases():
    ...
    return [{"input": "7000792289606361", "expected": "7000 79** **** 6361"}]
...
def card_with_spaces_and_dashes_cases():
    ...
    return [
        {"input": "7000 7922-8960-6361", "expected": "7000 79** **** 6361"},
        {"input": "7000-7922 8960 6361", "expected": "7000 79** **** 6361"},
    ]
...
def mask_account_test_cases():
    ...
    return [
        ...
        {"input": "12345", "expected": "**345", "description": "5 символов — маскируем первые 2 из последних 5."},
        {"input": "1234", "expected": "**34", "description": "4 символа — маскируем первые 2, оставляем 2."},
        {"input": "123", "expected": "**3", "description": "3 символа — маскируем первые 2, остаётся 1."},
        {"input": "12", "expected": "**", "description": "2 символа — заменяем оба на '*'."},
        {"input": "1", "expected": "*", "description": "1 символ — заменяем его на '*' (т.к. меньше 2)."},
        {"input": "", "expected": "", "description": "Пустая строка — возвращаем пустую строку."},
    ]
...
@pytest.fixture
def trans_default():
    return [{"id": 1, "state": "EXECUTED"}, {"id": 2, "state": "PENDING"}, {"id": 3, "state": "EXECUTED"}], [
        {"id": 1, "state": "EXECUTED"},
        {"id": 3, "state": "EXECUTED"},
    ]
...
@pytest.fixture
def trans_custom():
    return [{"id": 1, "state": "EXECUTED"}, {"id": 2, "state": "PENDING"}, {"id": 3, "state": "FAILED"}], [
        {"id": 2, "state": "PENDING"}
    ]
...
@pytest.fixture
def trans_no_match():
    return [{"id": 1, "state": "PENDING"}, {"id": 2, "state": "FAILED"}], []


@pytest.fixture
def trans_missing_key():
    return [{"id": 1, "state": "EXECUTED"}, {"id": 2, "status": "PENDING"}, {"id": 3, "state": "EXECUTED"}], [
        {"id": 1, "state": "EXECUTED"},
        {"id": 3, "state": "EXECUTED"},
    ]
...
def trans_case_sensitive():
    return [{"id": 1, "state": "executed"}, {"id": 2, "state": "EXECUTED"}, {"id": 3, "state": "Executed"}], [
        {"id": 2, "state": "EXECUTED"}
    ]
...
def trans_non_string():
    return [{"id": 1, "state": 1}, {"id": 2, "state": 2}], [{"id": 1, "state": 1}]


@pytest.fixture
def data_asc():
    return [{"id": 1, "date": "2023-01-15"}, {"id": 2, "date": "2022-12-01"}, {"id": 3, "date": "2023-03-10"}], [
...
@pytest.fixture
def missing_date():
    return [{"id": 1, "date": "2023-01-15"}, {"id": 2, "amount": 100}, {"id": 3, "date": "2022-12-01"}], [
...
@pytest.fixture
def same_dates():
    return [{"id": 1, "date": "2023-01-15"}, {"id": 2, "date": "2023-01-15"}, {"id": 3, "date": "2022-12-01"}], [
        {"id": 3, "date": "2022-12-01"},
        {"id": 1, "date": "2023-01-15"},
...
@pytest.fixture
def num_dates():
    return [{"id": 1, "date": 1673769600}, {"id": 2, "date": 1669852800}, {"id": 3, "date": 1681075200}], [
